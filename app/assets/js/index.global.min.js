...
var FullCalendar = (function (e) {
      ...
      __e: function (e, t, n, r) {
        for (var i, s, o; (t = t.__); )
          if ((i = t.__c) && !i.__)
            try {
              if (
                ((s = i.constructor) && null != s.getDerivedStateFromError && (i.setState(s.getDerivedStateFromError(e)), (o = i.__d)),
    ...
    triggerCustomRendering(e) {
      ...
      if (i) {
        ...
        r &&
          i(
            Object.assign(
              Object.assign({ id: this.id, isActive: e, containerEl: this.base, reportNewContainerEl: this.updateElRef, generatorMeta: r }, n),
  ...
  class gr {
    ...
    adjustActiveRange(e) {
      let { dateEnv: t, usesMinMaxTime: n, slotMinTime: r, slotMaxTime: i } = this.props,
        { start: s, end: o } = e;
      return (
        n && (vt(r) < 0 && ((s = Mt(s)), (s = t.add(s, r))), vt(i) > 1 && ((o = Mt(o)), (o = wt(o, -1)), (o = t.add(o, i)))), { start: s, end: o }
      );
    }
    ...
    trimHiddenDays(e) {
      let { start: t, end: n } = e;
      return (
        t && (t = this.skipHiddenDays(t)), n && (n = this.skipHiddenDays(n, -1, !0)), null == t || null == n || t < n ? { start: t, end: n } : null
      );
    }
    isHiddenDay(e) {
  ...
  class ti {
    ...
    setProp(e, t) {
      if (e in br) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
        ...
        let n = Ir[e](t);
        (n = 'color' === e ? { backgroundColor: t, borderColor: t } : 'editable' === e ? { startEditable: t, durationEditable: t } : { [e]: t }),
      ...
      return p(
        ...
        (n) =>
          p(
            'div',
            { className: 'fc-scrollgrid-sync-inner' },
            p(n, { elTag: 'a', elClasses: ['fc-col-header-cell-cushion', e.isSticky && 'fc-sticky'], elAttrs: { 'aria-label': t.format(s, ws) } })
          )
      );
    }
  }
  ...
  class Eo extends ls {
    constructor() {
      super(...arguments),
        (this.handleRootEl = (e) => {
          (this.rootEl = e),
            e ? this.context.registerInteractiveComponent(this, { el: e, useEventCenter: !1 }) : this.context.unregisterInteractiveComponent(this);
        });
    }
    render() {
      ...
      super(e),
        ...
        (this.onPointerMove = (e) => {
          if (this.isInteracting) {
            ...
            this.isDragging &&
              ('scroll' !== e.origEvent.type && (this.mirror.handleMove(e.pageX, e.pageY), this.autoScroller.handleMove(e.pageX, e.pageY)),
  ...
  function Ya(e, t) {
    ...
    return (
      Object.assign(
        n,
        ((r = e), { date: (i = t.dateEnv).toDate(r.range.start), dateStr: i.formatIso(r.range.start, { omitTime: r.allDay }), allDay: r.allDay })
      ),
      n
    );
  }
          ...
          if (this.isDragging) {
            ...
            if ((this.clearDrag(), t.emitter.trigger('eventDragStop', { el: this.subjectEl, event: a, jsEvent: e.origEvent, view: n }), i)) {
              if (r === t) {
                ...
                t.emitter.trigger(
                  'eventDrop',
                  Object.assign(Object.assign(Object.assign({}, d), u), { el: e.subjectEl, delta: i.datesDelta, jsEvent: e.origEvent, view: n })
                ),
                ...
                r.emitter.trigger('eventAdd', g),
                  ...
                  r.emitter.trigger(
                    'drop',
                    Object.assign(Object.assign({}, Ya(d.dateSpan, r)), { draggedEl: e.subjectEl, jsEvent: e.origEvent, view: d.context.viewApi })
                  ),
            ...
            (this.handlePointerDown = (e) => {
              ...
              (this.dragging.minDistance = t.context.options.eventDragMinDistance),
                this.dragging.setIgnoreMove(
                  !this.component.isValidSegDownEl(e.origEvent.target) || (e.isTouch && this.component.props.eventSelection !== r.instance.instanceId)
                );
            }),
            (this.handleDragStart = (e) => {
              ...
              (this.draggingSegEl = r),
                ...
                t.emitter.trigger('eventResizeStart', { el: r, event: new ti(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi });
            }),
            (this.handleHitUpdate = (e, t, n) => {
            ...
            t.map((t) => {
              ...
              return p(
                ...
                sl(t)
                  ? p(
                      al,
                      Object.assign({ seg: t, isDragging: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, mi(t, e.todayRange))
                    )
                  : p(
                      ol,
                      Object.assign(
    ...
    render() {
      ...
      return p(
        uo,
        {
          ...
          elAttrs: Object.assign(Object.assign(Object.assign({}, t.extraDataAttrs), t.showDayNumber ? { 'aria-labelledby': n.dayNumberId } : {}), {
            role: 'gridcell',
          }),
          defaultGenerator: fl,
          date: o,
  ...
  function ml(e, t, n, r, i, s, o) {
    ...
    let d = a.addSegs(l),
      u = a.toRects(),
      {
        ...
        for (let e = 0; e < n.length; e += 1) {
          ...
          for (let r of a) {
            let i = t[r.index];
            l.push({ seg: vl(i, e, e + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: r.levelCoord - c }),
          ...
          for (let r of a) {
            ...
            (d += r.levelCoord - c),
              ...
              s
                ? ((d += r.thickness),
                  o && u.push({ seg: vl(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !0, absoluteTop: r.levelCoord, marginTop: 0 }))
                : o &&
                  (u.push({ seg: vl(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: d }),
                  (d = 0));
          }
    ...
    for (let e of c) {
      ...
      for (let t = e.firstCol; t <= e.lastCol; t += 1)
        h[t].push({ seg: vl(e, t, t + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
    ...
    for (let t of d) {
      ...
      for (let e = r.start; e < r.end; e += 1)
        (p[e] += 1), h[e].push({ seg: vl(n, e, e + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
    }
              ...
              p(
                ...
                sl(t)
                  ...
                  : p(
                      ol,
                      Object.assign(
                        { seg: t, isDragging: i, isResizing: s, isDateSelecting: o, isSelected: f === l, defaultDisplayEventEnd: d },
                        mi(t, n)
                      )
                    )
              )
  ...
  class xl extends ls {
    ...
    renderSimpleLayout(e, t) {
      ...
      return (
        e &&
          i.push({ type: 'header', key: 'header', isSticky: s, chunk: { elRef: this.headerElRef, tableClassName: 'fc-col-header', rowContent: e } }),
        ...
        component: class extends xl {
          ...
          render() {
            let { options: e, dateProfileGenerator: t } = this.context,
              ...
              i =
                e.dayHeaders &&
                p(_s, { ref: this.headerRef, dateProfile: n.dateProfile, dates: r.headerDates, datesRepDistinctDays: 1 === r.rowCnt }),
              s = (t) =>
                p(wl, {
                  ref: this.tableRef,
  ...
  class Hl extends ls {
    ...
    renderSimpleLayout(e, t, n) {
      ...
      return (
        e &&
          s.push({ type: 'header', key: 'header', isSticky: o, chunk: { elRef: this.headerElRef, tableClassName: 'fc-col-header', rowContent: e } }),
        t &&
  ...
  class Kl extends Gn {
    ...
    renderNowIndicator(e) {
      ...
      return t
        ? e.map((e, r) =>
            p(lo, { key: r, elClasses: ['fc-timegrid-now-indicator-line'], elStyle: { top: t.computeDateTop(e.start, n) }, isAxis: !1, date: n })
          )
        : null;
    }
    computeSegHStyle(e) {
    ...
    return p(
      ...
      e.map((e) => {
        ...
        return p(
          ...
          p(Jl, Object.assign({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: i === r, isShort: !1 }, mi(e, t, n)))
        );
      })
    );
  }
                ...
                p(
                  ...
                  p(
                    ...
                    p(
                      ...
                      { className: 'fc-timegrid-now-indicator-container' },
                      'number' == typeof n &&
                        p(lo, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: n }, isAxis: !0, date: e.nowDate })
                    )
                  )
                ),
              e.cells.map((t, n) =>
        ...
        component: class extends Hl {
          ...
          render() {
            let { options: e, dateEnv: t, dateProfileGenerator: n } = this.context,
              ...
              u =
                e.dayHeaders &&
                p(_s, { dates: s.headerDates, dateProfile: i, datesRepDistinctDays: !0, renderIntro: c ? this.renderHeadAxis : null }),
              h =
                !1 !== e.allDaySlot &&
                ((t) =>
                  p(
        ...
        component: class extends ls {
          ...
          render() {
            ...
            return p(
              ...
              p(
                Fs,
                { liquid: !e.isHeightAuto, overflowX: e.isHeightAuto ? 'visible' : 'hidden', overflowY: e.isHeightAuto ? 'visible' : 'auto' },
                ...
                U(
                  p(
                    ...
                    (t, n, r, i) => (
                      ...
                      this.setHeight(n),
                      p($n.Provider, { value: this.customContentRenderId }, p(_a, Object.assign({ isHeightAuto: r, forPrint: i }, e)))
                    )
                  ),
                  this.el
                );
